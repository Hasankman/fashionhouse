...
public class ProductCategoryController {
	...
	@PutMapping("/updateProductCat/{id}")
	...
	public boolean deleteProductCategorys(@PathVariable Integer id) {
		return service.deleteProductCategory(id);
	}
	
	@GetMapping("/productCatById")
	public ProductCategoryDTO readProductCategoryById(@PathParam("id") Integer prodCatId) {
		return service.readById(prodCatId);
	}
	
	@GetMapping("/productCatByName")
	public ProductCategoryDTO readByName(@PathParam("name") String prodcatdesc){
		return service.readByName(prodcatdesc);
	}
}
